            ...
            <div class="page-width">
                ...
                <div class="grid-3" style="margin-bottom: 60px;">
                    <div class="card">
                        ...
                        <p data-i18n="cme.cases_desc">Learn from your own documented cases. CME Vault analyses your clinical encounters and surfaces relevant learning points — highlighting differential diagnoses you considered, evidence-based alternatives, and guideline-concordant management options. Your own practice becomes your most powerful educational resource.</p>
                    </div>
                    <div class="card">
                        <div class="card-icon material-symbols-rounded">school</div>
                        <h3 data-i18n="cme.cert_title">Certification Content</h3>
                        <p data-i18n="cme.cert_desc">Access curated learning modules aligned with major medical education accreditation frameworks. Modules are mapped to specialty competencies and can be completed at your own pace — during downtime between patients, on your commute, or during dedicated study sessions.</p>
                    </div>
                    <div class="card">
                        <div class="card-icon material-symbols-rounded">newspaper</div>
                        <h3 data-i18n="cme.updates_title">Clinical Updates</h3>
                        <p data-i18n="cme.updates_desc">Stay current with the latest clinical guidelines, pharmacological updates, and evidence-based practice changes. CME Vault aggregates and curates updates relevant to your specialty, so you receive the information that matters to your practice — not a firehose of irrelevant publications.</p>
                    </div>
                </div>

                <!-- Learning Tracking -->
                <div class="subpage-header">
                    <span class="kicker" data-i18n="cme.track_kicker">Track & Earn</span>
                    <h3 class="section-title" data-i18n="cme.track_title">Learning hours and credits, automatically tracked.</h3>
                    <p class="section-copy" data-i18n="cme.track_desc">CME Vault tracks every learning interaction — case reviews, module completions, and guideline reviews — and logs them against your CPD requirements. When renewal time comes, your learning record is already compiled.</p>
                </div>
                ...
                <div class="grid-2" style="margin-bottom: 60px;">
                    <div class="text-group" style="border-bottom: none;">
                        ...
                        <p data-i18n="cme.hours_desc">Every minute spent engaging with educational content is automatically logged. Case review sessions, module completions, and guideline readings are tracked and categorised by specialty domain, competency area, and accreditation body requirements.</p>
                        <ul style="margin-top: 15px; font-size: 14px;">
                    ...
                    <div class="text-group" style="border-bottom: none;">
                        ...
                        <h3 data-i18n="cme.credits_title">Credit Accumulation</h3>
                        <p data-i18n="cme.credits_desc">Earn CME/CPD credits as you learn. Completed modules and verified learning activities contribute to your credit balance, mapped to the requirements of your licensing jurisdiction and specialty board.</p>
                        <ul style="margin-top: 15px; font-size: 14px;">
                ...
                <div style="background: var(--bg-subtle); color: var(--text-primary); text-align: center; padding: 48px 40px; border-radius: 12px; border: 1px solid var(--border-subtle);">
                    ...
                    <div class="nav-actions" style="justify-content: center;">
                        <a href="#" class="btn-primary" style="background: var(--text-primary); color: white;" onclick="window.open('https://clinixsummary.ai/cpd-vault', '_blank')" data-i18n="cme.cta_primary">Activate CME Vault</a>
