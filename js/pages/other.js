        ...
        <section class="subpage-container">
            <div class="page-width">
                ...
                <div class="compliance-badges">
                    <div class="compliance-badge" data-evidence-id="privacy-frameworks">
                    ...
                    <div class="compliance-badge" data-evidence-id="soc2-iso27001">
                    ...
                    <div class="compliance-badge" data-evidence-id="mhra-class-i">
                        <span class="material-symbols-rounded">medical_services</span>
                        <div>
                            <div style="font-size: 15px;">MHRA &middot; UKCA</div>
                            <div style="font-size: 11px; color: var(--text-secondary); font-weight: 400;" data-i18n="security.badge_class1">Class I registered</div>
                        </div>
                    </div>
                    <div class="compliance-badge" data-evidence-id="privacy-frameworks">
                    ...
                    <div class="compliance-badge" data-evidence-id="encryption-retention">
                ...
                <p class="evidence-meta" style="font-size: 12px; color: var(--text-secondary); margin-top: 12px;">
                    <span data-i18n="security.evidence_reviewed">Last reviewed</span>:
                    <time datetime="2026-08-31">31 August 2026</time>
                </p>

                <!-- Section 2b: Medical Device Regulation (MHRA / UKCA) -->
                <div style="margin: 60px 0;">
                    <span class="kicker" data-i18n="security.mhra_kicker">Medical Device Regulation</span>
                    <h2 class="section-title" data-i18n="security.mhra_title">Registered with the MHRA. UKCA marked.</h2>
                    <p class="section-copy" style="max-width: 780px; margin-bottom: 32px;" data-i18n="security.mhra_desc">ClinixSummary is registered with the UK Medicines and Healthcare products Regulatory Agency (MHRA) as a Class I medical device and carries UKCA marking. Clinical documentation software that meets the regulatory bar your practice is held to.</p>
                    <div class="grid-3">
                        <div class="text-group" style="border-bottom: none;">
                            <h3 data-i18n="security.mhra_f1_title">MHRA registration</h3>
                            <p class="section-copy" data-i18n="security.mhra_f1_desc">Registered as a medical device with the UK regulator, with the obligations that registration carries — vigilance, traceability and post‑market surveillance.</p>
                        </div>
                        <div class="text-group" style="border-bottom: none;">
                            <h3 data-i18n="security.mhra_f2_title">UKCA marking</h3>
                            <p class="section-copy" data-i18n="security.mhra_f2_desc">The UKCA mark declares conformity with the UK Medical Devices Regulations for a Class I device — covering safety, performance and labelling requirements.</p>
                        </div>
                        <div class="text-group" style="border-bottom: none;">
                            <h3 data-i18n="security.mhra_f3_title">Governed by ClinixQM</h3>
                            <p class="section-copy" data-i18n="security.mhra_f3_desc">Our quality management system underpins the registration — documented processes for risk, change control, incident handling and continuous improvement.</p>
                        </div>
                    </div>
                </div>
    ...
    return `
        <section class="subpage-container">
            <div class="page-width">
                ...
                <div style="margin-top: 48px; padding: 24px; background: var(--bg-subtle); border-radius: 12px; border: 1px solid var(--border-subtle);">
                    <p style="font-size: 14px; color: var(--text-secondary); margin: 0;" data-i18n-html="status.report_note">Seeing a problem that isn’t listed here? Email <a href="mailto:support@clinixsummary.ai" style="color: var(--accent);">support@clinixsummary.ai</a> or <a href="/contact" style="color: var(--accent);">contact us</a>.</p>
                </div>
            </div>
        </section>
    `;
